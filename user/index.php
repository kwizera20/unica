                    ...
                    if($num>0){
                        ...
                        <div class="card m-3">
                          <div class="card-body text-center">
                            <h5 class="mb-2 text-dark font-weight-normal"><?php echo $row ['name'];?></h5>
                            <h2 class="mb-4 text-dark font-weight-bold"><?php echo $row ['price'];?> RWF</h2>
                            <div class="dashboard-progress"><img class="card-img-top embed-responsive-item"  src="../product-images/<?php echo $row['picture']; ?>"></div>
                            <p class="mt-4 mb-0"><?php echo $row ['color'];?></p>
                          <h3 class="mb-0 font-weight-bold mt-2 text-dark"><?php echo $row ['quantity'];?> Available</h3>
                          </div>
                        </div>
                        <?php
                }
          ...
          <footer class="footer">
            <div class="footer-inner-wraper">
              <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Internationaldeliver 2022</span>
