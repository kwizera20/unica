...
if(isset($_POST['submit'])){
    ...
    if($move){
         $insert="INSERT INTO productList(name,picture,color,size,price,quantity,date,description)values
         ('$name','$photoNewName','$color','$size','$price','$quantity','$date','$description');";
